...
public struct SlideMenuOptions {
    public static var leftViewWidth: CGFloat = 330.0//270.0
    ...
    public static var panFromBezel: Bool = false//true // 画面スワイプでサイドメニューを呼び出せるかどうか
    ...
    public static var hideStatusBar: Bool = true // ステータスバーの表示
